...
# 1 "spritesheet4.h" 1
# 21 "spritesheet4.h"
extern const unsigned short spritesheet4Tiles[16384];


extern const unsigned short spritesheet4Pal[256];
# 10 "main.c" 2
# 1 "spritesheet5.h" 1
# 21 "spritesheet5.h"
...
# 1 "startscreen1.h" 1
# 22 "startscreen1.h"
extern const unsigned short startscreen1Tiles[1184];
...
# 1 "startscreen2.h" 1
# 22 "startscreen2.h"
extern const unsigned short startscreen2Tiles[10544];


extern const unsigned short startscreen2Map[2048];
...
# 1 "startscreen3.h" 1
# 22 "startscreen3.h"
extern const unsigned short startscreen3Tiles[1280];


extern const unsigned short startscreen3Map[2048];


extern const unsigned short startscreen3Pal[256];
# 20 "main.c" 2
# 1 "winscreen.h" 1
# 22 "winscreen.h"
...
# 23 "main.c" 2
# 1 "instructionstext.h" 1
# 22 "instructionstext.h"
extern const unsigned short instructionstextTiles[1776];


extern const unsigned short instructionstextMap[1024];


extern const unsigned short instructionstextPal[256];
# 24 "main.c" 2
# 1 "pausescreen.h" 1
# 22 "pausescreen.h"
...
void initialize() {
 ...
 (*(volatile unsigned short*)0x4000008) = ((0)<<2) | (1<<7) | ((31)<<8) | (0<<14);

 (*(volatile unsigned short*)0x400000A) = ((1)<<2) | (0<<7) | ((30)<<8) | (1<<14);

 (*(volatile unsigned short*)0x400000C) = ((2)<<2) | (0<<7) | ((28)<<8) | (1<<14);
...
void start() {
 ...
 if ((!(~(oldButtons)&((1<<6))) && (~buttons & ((1<<6))))) {
  if (cheat == 0) {
   cheat = 1;
   DMANow(3, startscreen3Tiles, &((charblock *)0x6000000)[1], 2560 / 2);
   DMANow(3, startscreen3Map, &((screenblock *)0x6000000)[30], 4096 / 2);
   DMANow(3, startscreen3Pal, ((unsigned short *)0x5000000), 512 / 2);
  } else {
   cheat = 0;
   DMANow(3, startscreen1Tiles, &((charblock *)0x6000000)[1], 2368 / 2);
   DMANow(3, startscreen1Map, &((screenblock *)0x6000000)[30], 4096 / 2);
   DMANow(3, startscreen1Pal, ((unsigned short *)0x5000000), 512 / 2);
  }
 }
 startHOff++;
 (*(volatile unsigned short *)0x04000018) = startHOff / 2000;
}
...
void goToStart() {
 ...
 if (!dontplay) {
  playSoundA(startsound, 1786176, 11025, 1);
 }
 dontplay = 0;
 if (cheat) {
  DMANow(3, startscreen3Tiles, &((charblock *)0x6000000)[1], 2560 / 2);
 ...
 DMANow(3, startscreen2Tiles, &((charblock *)0x6000000)[2], 21088 / 2);
 DMANow(3, startscreen2Map, &((screenblock *)0x6000000)[28], 4096 / 2);
...
void goToInstructions() {
 (*(unsigned short *)0x4000000) = 0 | (1<<9) | (1<<10) | (1<<12);
 DMANow(3, instructionstextTiles, &((charblock *)0x6000000)[1], 3552 / 2);
 DMANow(3, instructionstextMap, &((screenblock *)0x6000000)[30], 2048 / 2);
 DMANow(3, instructionstextPal, ((unsigned short *)0x5000000), 512 / 2);
 hideSprites();
 state = INSTRUCTIONS;
}
...
void goToGame() {
 (*(unsigned short *)0x4000000) = 0 | (1<<9) | (1<<10) | (1<<12);
 if (!dontplay) {
  playSoundA(fightsound, 398880, 11025, 1);
 }
 dontplay = 0;
 ...
 if (!cheat) {
  DMANow(3, spritesheet1Pal, ((unsigned short *)0x5000200), 512 / 2);
  DMANow(3, spritesheet1Tiles, &((charblock *)0x6000000)[4], 32768 / 2);
 } else {
  DMANow(3, spritesheet4Pal, ((unsigned short *)0x5000200), 512 / 2);
  DMANow(3, spritesheet4Tiles, &((charblock *)0x6000000)[4], 32768 / 2);
 }
 DMANow(3, bg1Tiles, &((charblock *)0x6000000)[1], 12320 / 2);
 DMANow(3, bg1Map, &((screenblock *)0x6000000)[30], 4096 / 2);
 DMANow(3, bg1Pal, ((unsigned short *)0x5000000), 512 / 2);
 DMANow(3, bg2Tiles, &((charblock *)0x6000000)[2], 5056 / 2);
...
void goToPause() {
 ...
 DMANow(3, pausescreenTiles, &((charblock *)0x6000000)[0], 37120 / 2);
...
void goToWin() {
 ...
 dontplay = 0;
 (*(volatile unsigned short *)0x04000010) = 0;
 DMANow(3, winscreenTiles, &((charblock *)0x6000000)[0], 38208 / 2);
...
void goToLose() {
 (*(unsigned short *)0x4000000) = 0 | (1<<8) | (1<<12);
 (*(volatile unsigned short *)0x04000010) = 0;
 DMANow(3, losescreenTiles, &((charblock *)0x6000000)[0], 37632 / 2);
