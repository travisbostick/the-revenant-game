...
void DMANow(int channel, volatile const void *src, volatile void *dst,
    unsigned int cnt) {
...
int collision(int rowA, int colA, int heightA, int widthA, int rowB, int colB,
...
void hideSprites() {
    ...
    // This is where you will see the dreaded Cornerface if you do not
