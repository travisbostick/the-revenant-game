...
SOURCES            = main.c myLib.c sound.c game.c spritesheet1.c spritesheet2.c spritesheet3.c spritesheet4.c spritesheet5.c bg.c bg1.c bg2.c startscreen1.c startscreen2.c startscreen3.c winscreen.c losescreen.c instructionsscreen.c instructionstext.c pausescreen.c startsound.c fightsound.c punchsound.c knifesound.c
